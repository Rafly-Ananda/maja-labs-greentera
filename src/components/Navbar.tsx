    ...
    <div className="h-[60px] lg:h-[85px] text-[#222533] flex items-center justify-center font-[family-name:var(--font-montserrat)] z-50 bg-white fixed w-full">
      ...
      <div className="w-[1180px] lg:flex items-center justify-between hidden ">
        <ul className="flex items-center justify-center gap-10 w-fit">
          <Image src={NavLogo} width={40} height={40} alt="Nav Logo" />
          {navLinks.map((e, i) => (
            <li className=" uppercase text-[0.85rem]" key={e + i}>
              {e}
            </li>
          ))}
        </ul>

        <button className="uppercase text-[0.85rem] bg-[#c6b4ff] rounded-3xl px-4 py-3 font-medium w-fit">
          participate
        </button>
      </div>
      ...
      <div className="w-[1180px] lg:hidden flex items-center justify-between p-5 ">
        ...
        <div className="flex items-center z-50">
          <button className="uppercase text-[10px] bg-[#c6b4ff] rounded-full lg:rounded-3xl px-[12px] py-[6px] font-medium w-fit h-fit z-50">
            participate
          </button>
          <div>
            <Hamburger
